...
import rclpy
from rosgraph_msgs.msg import Clock  # <--- Add this
...
class DRLGazebo(Node):
    def __init__(self):
        ...
        # 1. ADD THIS CLOCK SUBSCRIPTION (The QoS Fix)
        ...
        # 2. FIX THE PATH (Changed python3.8 to python3.10 for Humble)
    ...
    *******************************************************************************"""
    ...
    def clock_callback(self, msg):
        pass # This just "wakes up" the node when the clock ticks
